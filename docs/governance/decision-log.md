...
| D-002 | Begin with CRM research, requirements/user stories and a starter-code gap analysis before major implementation. | Confirmed | Client meeting was postponed, and there is still insufficient clarity regarding their requirements.Repeated direction from Peter and Leon. | Accepted |
...
| D-011 | Deliver a low-fi or hi-fi prototype demonstration and clear user requirements documentation by the end of Sprint 1. | Proposed | Enables the client to visually track project progress and validate that their requirements are being met. | Proposed |
